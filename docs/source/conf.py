# -*- coding: utf-8 -*-
#
# PolyPharma_BioNetworkAnalyzer documentation build configuration file, created by
...
project = u'PolyPharma_BioNetworkAnalyzer'
copyright = u'2015, Andrei Kucharavy'
...
htmlhelp_basename = 'PolyPharma_BioNetworkAnalyzerdoc'
...
texinfo_documents = [
  ('index', 'PolyPharma_BioNetworkAnalyzer', u'PolyPharma_BioNetworkAnalyzer Documentation',
   u'Andrei Kucharavy', 'PolyPharma_BioNetworkAnalyzer', 'One line description of project.',
   'Miscellaneous'),
]
