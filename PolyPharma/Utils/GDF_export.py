...
class GDF_export_Interface(object):
    ...
    def __init__(self, target_fname, field_names, field_types, node_properties_dict, mincurrent, Idx2Label, Label2Idx, current_Matrix, directed=False):
        ...
        self.mincurrent = mincurrent*current_Matrix[current_Matrix.nonzero()].toarray().max() # minimal current for which we will be performing filtering out of the conductances and nodes through whichthe trafic is below that limit
