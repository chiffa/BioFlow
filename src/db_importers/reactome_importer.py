...
from src.main_configs import Dumps, ReactomeBioPax
from src.internal_configs import Leg_ID_Filter
from src.neo4j_db.GraphDeclarator import DatabaseGraph
from src.neo4j_db.db_io_routines import get_bulbs_id
from src.bio_db_parsers.reactomeParser import ReactomeParser
...
def insert_meta_objects(bulbs_graph_class, meta_id_2_property_dict):
    ...
    Inserst a Meta-Object (I.e. any physical entity or collection thereof) as a member of a
     bulbs class and pumping the src information from the property src
...
def insert_reactions(bulbs_graph_class, property_source_dict):
    ...
    class and pumping the src information from the property src
