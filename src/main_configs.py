...
from src.configs_manager import parse_configs, conf_file_path_flattener
from src.utils.general_utils import high_level_os_io as hl_os_io
...
# Where the RNA counts src, hits and background deduced from it are to be found  #
# TODO: these should be input dynamically; or at least from a different src file because of a
