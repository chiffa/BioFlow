...
from src.utils.dataviz import render_2d_matrix
from src.internal_configs import fudge
from src.utils.linalg_routines import cluster_nodes, average_off_diag_in_sub_matrix, \
...
def build_sink_source_current_array(io_index_pair, shape):
    ...
    :param io_index_pair: pair of indexes where sinks/src pair is
    """
