...
from src.utils.gdfExportInterface import GdfExportInterface

from src.utils.io_Routines import write_to_csv, dump_object, undump_object

from src.utils.log_behavior import get_logger

from src.main_configs import Chromosome_source, Chromosome_file_filter

from src.main_configs import Dumps, Outputs, Interactome_rand_samp

from src.internal_configs import edge_type_filters, Adjacency_Martix_Dict, \
    Conductance_Matrix_Dict

from src.neo4j_db.GraphDeclarator import DatabaseGraph

from src.neo4j_db.db_io_routines import expand_from_seed, \
    erase_custom_fields, node_extend_once, get_bulbs_id

from src.neo4j_db.graph_content import bulbs_names_dict
...
class InteractomeInterface(object):
    ...
    def build_extended_conduction_system(
        ...
        :param cancellation: divides the final current by number of src-sink pairs
