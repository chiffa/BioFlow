...
from src.main_configs import IDFilter, Dumps, analysis_protein_ids_csv, \
    analysis_set_display_names, analysis_set_bulbs_ids, \
    background_protein_ids_csv, background_set_bulbs_ids
from src.internal_configs import edge_type_filters, Leg_ID_Filter, annotation_nodes_ptypes
from src.neo4j_db.GraphDeclarator import DatabaseGraph
from src.neo4j_db.graph_content import bulbs_names_dict, full_list, forbidden_verification_list
...
def cast_analysis_set_to_bulbs_ids():
    """
    Unwraps the src file specified in the analysis_protein_ids_csv, translates its database
...
def cast_background_set_to_bulbs_id():
    """
    Unwraps the src file specified in the background_bulbs_ids, translates it to the database
    internal ids for further use
    :return:
    """
