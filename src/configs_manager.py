...
from src.utils.general_utils.dict_like_configs_parser import ini_configs2dict, dict2init_configs
from src.utils.general_utils.high_level_os_io import mkdir_recursive
from src.utils.general_utils.internet_io import url_to_local
...
class StructureGenerator(object):
    ...
    def build_source_config(cls, pl_type):
        """
        Writes a src file based on the string organism argument
